expected <- eval(parse(text="c(\"structure(list(Sex = structure(c(2L, 2L, 1L, 1L, 2L, 2L), .Label = c(\\\"Female\\\", \", \"\\\"Male\\\"), class = \\\"factor\\\"), age = c(15, 20, 10, 12, 2, 4), Subject = structure(c(2L, \", \"2L, 1L, 1L, 3L, 3L), .Label = c(\\\"F30\\\", \\\"M01\\\", \\\"M04\\\"), class = \\\"factor\\\")), row.names = c(NA, \", \"-6L), class = \\\"data.frame\\\")\")"));
test(id=0, code={
