...
new BuiltInFunction("loadInfoFromConn2",do_loadInfoFromConn2,0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("serializeInfoFromConn", do_serializeInfoFromConn,	0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
