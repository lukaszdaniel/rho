...
namespace rho
{
    ...
    */
   FunctionBase *findFunction(const Symbol *symbol, Environment *env, bool inherits = true);
...
extern "C"
{
    ...
    */
   inline Rboolean ENV_RDEBUG(SEXP x)
   {
      using namespace rho;
    ...
    */
   inline void SET_ENV_RDEBUG(SEXP x, Rboolean v)
   {
      using namespace rho;
      Environment &env = *SEXP_downcast<Environment *>(x);
