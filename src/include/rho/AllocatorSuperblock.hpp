...
namespace rho
{
  ...
  public:
     ...
     * superblock.
     */
    AllocatorSuperblock(unsigned size_class, unsigned bitset_entries) : m_size_class(size_class),
                                                                        m_next_untouched(0)
    {
    ...
    {
      return pointer >= reinterpret_cast<uintptr_t>(this) && pointer < endPointer();
    }
