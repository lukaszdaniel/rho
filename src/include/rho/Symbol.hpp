 ...
 */
     ...
     */
        bool isSpecialSymbol() const { return m_is_special_symbol; }
     ...
     */
        static Symbol *obtainS3Signature(
     ...
     */
        static const char *staticTypeName() { return "symbol"; }
 ...
 */
    ...
    namespace Symbols
    {
#define PREDEFINED_SYMBOL(C_NAME, RHO_NAME, R_NAME) extern Symbol *RHO_NAME;
...
#define PREDEFINED_SYMBOL(C_NAME, RHO_NAME, R_NAME) extern SEXP C_NAME;
#include <rho/PredefinedSymbols.hpp>
#undef PREDEFINED_SYMBOL
 ...
 * the required name.
 */
    inline SEXP Rf_install(const char *name) { return rho::Symbol::obtain(name); }
