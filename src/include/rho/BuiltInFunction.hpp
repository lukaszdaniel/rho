...
namespace rho
{
    ...
    private:
        ...
        typedef RObject *(*FixedNativeFnStorage)(
            Expression *, const BuiltInFunction *, class SequenceOfRObject *);
        // Function that takes a variable number of arguments.
        typedef RObject *(*VarArgsNativeFn)(
            Expression *, const BuiltInFunction *, int num_args, ...);
        ...
        bool argsHaveClassToDispatchOn(
            RObject *const *evaluated_args, int num_args) const
        {
            switch (num_args)
            {
            case 0:
        ...
        bool argsHaveClassToDispatchOn(
            const RObject *arg1 = nullptr, const RObject *arg2 = nullptr, ...) const
        {
            assert(m_dispatch_type != DispatchType::NONE);
