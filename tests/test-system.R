...
for(to in tos) {
    ...
    process(system(paste(test.system2, "1"), input=letters[1:4], timeout = to))
    ...
    print(system(paste(test.system2, "5"), timeout = to))
    system(paste(test.system2, "6"), intern = TRUE, timeout = to)
