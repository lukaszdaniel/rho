...
namespace rho
{
    ...
    public:
        ...
        public:
            Scope()
                : m_next_scope(RAllocStack::s_innermost_scope), m_saved_size(RAllocStack::size())
            {
		 ...
		 */
            size_t startSize() const { return m_saved_size; }
         ...
         */
        static size_t size() { return s_stack->size(); }
