...
new BuiltInFunction("loadInfoFromConn2",do_loadFromConn2,1,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("serializeInfoFromConn", do_unserializeFromConn,	1,	11,	2,	{PP_FUNCALL, PREC_FN,	0}),
